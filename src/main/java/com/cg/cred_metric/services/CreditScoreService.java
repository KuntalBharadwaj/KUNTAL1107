...
public class CreditScoreService {
    ...
    // Core calculation logic (used by both scheduler and manual endpoint)
...
//
//        // Calculate Payment History Penalty (35%)
//        long totalRepayments = repayments.size();
//        long onTime = repayments.stream().filter(r -> r.getRepaymentStatus() == Repayment.RepaymentStatus.ONTIME).count();
//        long missedRepayments = totalRepayments - onTime;
//        double paymentHistoryPenalty = missedRepayments > 0 ? -50 : 0;
//
//        // Calculate Credit Utilization Penalty (30%)
...
//            utilizationRatio = totalUsed.divide(totalLimit, 2, RoundingMode.HALF_UP);
//        }
//
//        int utilizationPenalty = utilizationRatio.compareTo(threshold) > 0 ? -30 : 0;
//
//        // Calculate Credit Mix Bonus (10%)
...
//        double creditMixBonus = (secured > 0 && unsecured > 0) ? 10 : 0;
//
//        // Calculate New Credit Enquiries Penalty (10%)
//        LocalDate sixMonthsAgo = LocalDate.now().minusMonths(6);
//        long recentCreditEnquiries = loanRepository.countByUserAndStartDateAfter(user, sixMonthsAgo);
//        double newCreditEnquiriesPenalty = recentCreditEnquiries > 2 ? -20 : 0;
//
//        // Calculate Length of Credit History Bonus (15%)
//        LocalDate earliestLoanDate = LocalDate.now();
//
//        if (!loans.isEmpty()) {
//            earliestLoanDate = loans.get(0).getStartDate();
//            for (Loan loan : loans) {
//                if (loan.getStartDate().isBefore(earliestLoanDate)) {
//                    earliestLoanDate = loan.getStartDate();
//                }
//            }
//        }
//
//        LocalDate earliestCardDate = LocalDate.now();
//
//        if (!cards.isEmpty()) {
//            earliestCardDate = cards.get(0).getIssueDate();
//            for (CreditCard card : cards) {
//                if (card.getIssueDate().isBefore(earliestCardDate)) {
//                    earliestCardDate = card.getIssueDate();
//                }
//            }
//        }
//
//        LocalDate oldestCreditDate = earliestLoanDate.isBefore(earliestCardDate)
//                ? earliestLoanDate : earliestCardDate;
//
//        long creditHistoryMonths = ChronoUnit.MONTHS.between(oldestCreditDate, LocalDateTime.now());
//        double creditHistoryBonus = creditHistoryMonths >= 12 ? 10 : 0;
//
//        System.out.println(paymentHistoryPenalty);
//        System.out.println(utilizationPenalty);
//        System.out.println(creditMixBonus);
//        System.out.println(newCreditEnquiriesPenalty);
//        System.out.println(creditHistoryBonus);
//
//        // Calculate Final Score
//        double finalScore = baseScore
//                + paymentHistoryPenalty * 0.35
//                + utilizationPenalty * 0.30
//                + creditMixBonus * 0.10
//                + newCreditEnquiriesPenalty * 0.10
//                + creditHistoryBonus * 0.15;
//
